...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/KMBHNKizdm574gRWmVTisn')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100064918785739')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    ssb = input('Put File Name:')
    print(" ")
    sumon = input('Saving Put File Name:')
    os.system('touch ' +sarfraz)
